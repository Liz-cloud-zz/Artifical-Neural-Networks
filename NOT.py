...
if __name__ == '__main__':
    ...
    if generate_training_set:
        ...
        for i in range(num_train):
            ...
            training_labels.append(0.0 if training_examples[i][0] < 0.8 else 1.0)
            # if training_examples[i][0] < 0.8 :
    ...
    if generate_validation_set:
        ...
        for i in range(num_train):
            ...
            validate_labels.append(1.0 if validate_examples[i][0] < 0.8 else 0.0)
            # if validate_examples[i][0] < 0.8:
